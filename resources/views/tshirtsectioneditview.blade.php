...
<body>
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <!-- Navbar End -->
             <h1 align="center" style="color:red;">ALL T-SHIRT  </h1>
            <!-- Recent Sales Start -->
                ...
                <div class="bg-secondary text-center rounded p-4">
                    ...
                    <div class="table-responsive">
                       ...
                       <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            @foreach ($TshirtData->all() as $item)
                            <tbody align="center">
                                <tr>
                                    <td>{{$item->Name}}</td>
                                    <td>{{$item->Price}}</td>
                                    ...
                                    <td><a class="btn btn-sm btn-success" href="{{url('/tshirt_edit')}}{{$item->User_id}}">Edit</a> <a class="btn btn-sm btn-primary" href="{{url('/tshirt_del')}}{{$item->User_id}}">Delete</a></td>
                                </tr>
