...
<body>
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <!-- Navbar End -->
             <h1 align="center" style="color:red;">ALL REGISTER DELIVERY PARTNER</h1>
            <!-- Recent Sales Start -->
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h3 class="mb-0" >ALL DELIVERY PARTNER</h3>
                    </div>
                       ...
                       <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody align="center">
                                <tr>
                                    ...
                                    <td><img src="{{$item->Document}}" alt="" height="40px" width="40px"></td>
                                    <td><a class="btn btn-sm btn-primary" href="{{url('/deliveryblock')}}{{$item->User_id}}">BLOCK</a> <a class="btn btn-sm btn-success" href="{{url('/deliveryunblock')}}{{$item->User_id}}">UNBLOCK</a></td>
                                    <td>@if ($item->Auth==0)
                                        <b>Unblock</b>
                                        @else
                                        <b>Block</b>
