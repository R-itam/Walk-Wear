    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="container-fluid">
            ...
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                ...
                <h1 align="center" style="color:red;"><i>NIKE DELIVERY</i></h1>
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            
                                <h3 class="text-primary"><img src="banner/cover/walk.png" alt="" height="50px" width="90px"></h3>
                        ...
                        @endif
                        <form action="{{url('/deliveryloginaction')}}" method="post" enctype="multipart/form-data">
                            @csrf
