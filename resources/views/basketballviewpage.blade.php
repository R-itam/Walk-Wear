...
<body>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px;background-image:url(banner/cover/l1.jpg);
            ...
            <h1 class="font-weight-semi-bold text-uppercase mb-3" style="color:red;">BASKETBALL SHOE SECTION</h1>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 pb-1 text-center" style="padding:60px;">
            <div class="card product-item border-0 mb-4">
               ...
               <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                    <img class="img-fluid mx-auto d-block" src="{{$item->Image}}" name="s_avatar" alt="" height="100px" width="100px">
                    <input type="hidden" name="s_avatar" value="{{$item->Image}}">
                </div>
                <div class="card-body border-left border-right text-center p-0 pt-4 pb-3" >
                    <h4 class="text-truncate mb-3"><input type="text" name="s_name" value="{{$item->Name}}" readonly ></h4><br>
                    <h5  style="margin-right:60px;">Color: <input type="text" value="{{$item->Color}}" name="s_color" readonly  ></h5>
                    <div class="d-flex justify-content-center" >
                      <h4>&#8377;<input type="number" value="{{$item->Price}}" name="s_price" readonly style="width:100px;margin-right:100px;"> </h4>
                      <p>size:
                      <select name="s_size" id="size-{{$item->User_id}}" required>
                      <option value=""></option>
                      ...
                      <h6>Qty:<input type="number" value="0" id="qty-{{$item->User_id}}" name="s_qty" style="width:30px;margin-button:20px;" min="0" required></h6>
                    </div>
