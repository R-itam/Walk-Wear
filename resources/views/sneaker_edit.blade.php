                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <h3 style="color:red;">EDIT SNEAKER EDITION</h3>
                        </div>
                       @if (isset($SndTail))
                       @foreach ($SndTail->all() as $all)
                       <form action="{{url('/sneakeditaction')}}" method="post" enctype="multipart/form-data">
                        @csrf
                       ...
                       @endif
                        <center><a href="{{url('/sneakersectioneditview')}}">  < < <  </a></center>
