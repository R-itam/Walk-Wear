    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <h1 align="center" style="color:red;">DELIVERY  SECTION</h1><br><br>
                <div class="row g-4">
                    <div class="col-sm-12 col-md-6 col-xl-4">
                        <div class="h-100 bg-secondary rounded p-4">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <h3 style="color:red;"   >DELIVERY PARTNER ADD</h3>
                            </div>
                            <img src="banner/cover/av.jfif" alt="" height="200px"width="350px">
                           <hr>
                         <center>  <a href="{{url('/deliveryparttadd')}}"class="btn btn-md btn-primary">ADD >>></a></center>
                    ...
                    <div class="col-sm-12 col-md-6 col-xl-4">
                        <div class="h-100 bg-secondary rounded p-4">
                        <div class="d-flex align-items-center justify-content-between mb-2">
                                <h3 style="color:red;"   >ALL DELIVERY PARTNER </h3>
                            </div>
                            <img src="banner/cover/avtar.avif" alt="" height="200px" width="350px">
                           <hr>
                         <center>  <a href="{{url('/deliverypartview')}}"class="btn btn-md btn-primary">ALL >>></a></center>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-6 col-xl-4">
                        <div class="h-100 bg-secondary rounded p-4">
                        <div class="d-flex align-items-center justify-content-between mb-2">
                                <h3 style="color:red;"   > ASSIGN DELIVERY PARTNER </h3>
                            </div>
                            <img src="banner/cover/Custobar.webp" alt="" height="200px" width="350px">
                           <hr>
                         <center>  <a href="{{url('/deliveryassignview')}}"class="btn btn-md btn-primary">ASSIGN >>></a></center>
                        </div>
                    </div>
                    <!--  -->
                   
                    </div>
                     <div class="br" style="margin-top:15%;"></div>
