    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <h1 align="center" style="color:red;">JACKET SECTION</h1><br><br>
                <div class="row g-4">
                    <div class="col-sm-12 col-md-6 col-xl-4">
                        <div class="h-100 bg-secondary rounded p-4">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <h3 style="color:red;"   >JACKET ADD</h3>
                            </div>
                            <img src="banner/jacket/FURGCEL.png" alt="" height="200px"  width="350px">
                           <hr>
                         <center>  <a href="{{url('/jacketadd')}}"class="btn btn-md btn-primary">ADD >>></a></center>
                    ...
                    <div class="col-sm-12 col-md-6 col-xl-4">
                        <div class="h-100 bg-secondary rounded p-4">
                        <div class="d-flex align-items-center justify-content-between mb-2">
                                <h3 style="color:red;"   >JACKET EDIT</h3>
                            </div>
                            <img src="banner/jacket/SFJKT.png" alt="" height="200px" width="350px">
                           <hr>
                         <center>  <a href="{{url('/jacketeditview')}}"class="btn btn-md btn-primary">EDIT & DELETE >>></a></center>
                        </div>
                    </div>
