...
<body>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px;background-image:url(banner/cover/l1.jpg);
            ...
            <h1 class="font-weight-semi-bold text-uppercase mb-3" style="color:red;">JACKET SECTION</h1>
        ...
        <button type="submit" class="btn btn-primary ml-2">Search</button>
                            ...
                            <div class="dropdown ml-4">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="triggerId">
                                    ...
                                    <a class="dropdown-item" href="{{ url()->current() }}?sort=men">Men</a>
                                    <a class="dropdown-item" href="{{ url()->current() }}?sort=women">Women</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    @if (isset($jacketInfo))
                    @if ($jacketInfo->isEmpty())
            ...
            <h4 class="text-muted">Can't find anything.</h4>
                    ...
                    @else
                    @foreach ($jacketInfo->all() as $item )
