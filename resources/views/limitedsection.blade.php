    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <h1 align="center" style="color:red;">LIMITED EDITION SECTION</h1><br><br>
                <div class="row g-4">
                    <div class="col-sm-12 col-md-6 col-xl-4">
                        <div class="h-100 bg-secondary rounded p-4">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <h3 style="color:red;"   >LIMITED EDITION ADD</h3>
                            </div>
                            <img src="banner/limited/dior.webp" alt="" height="200px">
                           <hr>
                         <center>  <a href="{{url('/limitedadd')}}"class="btn btn-md btn-primary">ADD >>></a></center>
                    ...
                    <div class="col-sm-12 col-md-6 col-xl-4">
                        <div class="h-100 bg-secondary rounded p-4">
                        <div class="d-flex align-items-center justify-content-between mb-2">
                                <h3 style="color:red;"   >LIMITED EDITION EDIT</h3>
                            </div>
                            <img src="banner/limited/travis-scoot.webp" alt="" height="200px" width="350px">
                           <hr>
                         <center>  <a href="{{url('/limitedsectioneditview')}}"class="btn btn-md btn-primary">EDIT & DELETE >>></a></center>
                        </div>
                    </div>
