...
<body>
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <!-- Navbar End -->
             <h1 align="center" style="color:red;">ALL SPORT SHOE </h1>
            <!-- Recent Sales Start -->
                       ...
                       <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody align="center">
                                <tr>
                                    ...
                                    <td><a class="btn btn-sm btn-success" href="{{url('/sport_edit')}}{{$item->User_id}}">Edit</a> <a class="btn btn-sm btn-primary" href="{{url('/sport_del')}}{{$item->User_id}}">Delete</a></td>
                                </tr>
