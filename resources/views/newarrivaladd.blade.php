                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <h3 style="color:red;">ADD NEW ARRIVAL</h3>
                        </div>
                       <form action="{{url('newarrivaladdaction')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-floating mb-3">
                        
                            <input type="text" class="form-control" id="floatingText" placeholder="model name" name="model_nm">
                            <label for="floatingText">Model Name</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="number" class="form-control" id="floatingInput" placeholder="price" name="m_price">
                            <label for="floatingInput"> Price</label>
                        </div>
                        <div class="form-floating mb-4">
                            <input type="text" class="form-control" id="floatingPassword" placeholder="Password" name="m_color">
                            <label for="floatingPassword">Color</label>
                        </div>
                        <div class="form-floating mb-4">
                            <input type="text" class="form-control" id="floatingPassword" placeholder="Password" name="m_cat">
                            <label for="floatingPassword">Catagory</label>
                        </div>
                        <div>
                            <label for="photo">Upload Photo:</label>
                            <input type="file" class=""  placeholder="Password" name="m_avatar">
                            
                        </div><br>
                      
                        <button type="submit" class="btn btn-primary py-3 w-100 mb-4">ADD </button><br>
                       </form>
                        <center><a href="{{url('/newarrivalsection')}}">  < < <  </a></center>
