...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row align-items-center py-3 px-xl-5">
            ...
            <img src="banner/cover/logo.png" alt="" height="70px">
            </div>
        ...
        <div class="row px-xl-5">
            <div class="col-lg-8">
                <div class="mb-4">
                    ...
                    @if (isset($Orditem))
                   <form action="{{url('/ordersubmitaction')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6 form-group">
                            <label> Name</label>
                            <input class="form-control" type="text" name="name" placeholder="John" value="{{$Orditem[0]->Name}}" readonly>
                        </div>
                       
                        <div class="col-md-6 form-group">
                            <label>E-mail</label>
                            <input class="form-control" type="email" name="email" placeholder="example@email.com"  value="{{$Orditem[0]->Email}}" readonly>
                        </div>
                        <div class="col-md-6 form-group">
    ...
    <div class="card border-secondary mb-5">
        ...
        <div class="card-body">
            @if (isset($Orditem))
                ...
                @foreach ($Orditem->all() as $item)
                
                    <tr>
                        <td>{{ $item->Product_name }} <input type="hidden" name="p_name[]" value="{{ $item->Product_name }}"></td>
                        <td>{{ $item->Size }} <input type="hidden" name="p_size[]" value="{{ $item->Size }}"></td>
                        <td>{{ $item->Quantity }} <input type="hidden" name="p_qty[]" value="{{ $item->Quantity }}"></td>
                        <td>{{ number_format($item->Price, 2) }} <input type="hidden" name="p_price[]" value="{{ $item->Price }}"></td>
                    </tr>
