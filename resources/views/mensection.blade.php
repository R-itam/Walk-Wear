...
<body>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 4  00px;background-image:url(banner/cover/logo1.jpg);
            background-repeat:no-repeat;
            background-size:cover ;">
            <h1 class="font-weight-semi-bold text-uppercase mb-3" style="color:white;font-weight:40px;"><strong>MEN SECTION</strong></h1>
            ...
            <div class="card product-item border-0 mb-4">
                ...
                <div class="card-body border-left border-right text-center p-0 pt-4 pb-3" >
                    ...
                    <div class="d-flex justify-content-center" >
                      ...
                      <p>size:
                      <select name="s_size" id="ssize-{{$item1->User_id}}">
                      <option value=""></option>
                        <option value="6">6</option>
                         <option value="7">7</option>
                          <option value="8">8</option>
                      ...
                      <h6>Qty:<input type="number" value="0" id="sqty-{{$item1->User_id}}" name="s_qty" style="width:30px;margin-button:20px;" min="0"></h6>
                    </div>
                ...
                <input type="hidden" name="s_size" id="shidden-size-{{$item1->User_id}}">
                <input type="hidden" name="s_qty" id="shidden-qty-{{$item1->User_id}}">
                <button type="submit" class="btn1 btn-sm btn-primary mx-auto" onclick="updateBuyNowFormm({{$item1->User_id}})">Buy Now</button>
               </form>
                </div>
            </div>
        </div>
    ...
    <div class="col-lg-4 col-md-6 col-sm-12 pb-1 text-center" style="padding:60px;">
            <div class="card product-item border-0 mb-4">
                ...
                <div class="card-body border-left border-right text-center p-0 pt-4 pb-3" >
                    ...
                    <h5 style="margin-right:60px;">Color: <input type="text" value="{{$item->Color}}" name="s_color" readonly  ></h5>
                    <div class="d-flex justify-content-center" >
                      <h4>&#8377;<input type="number" value="{{$item->Price}}" name="s_price" readonly style="width:117px;margin-right:100px;" > </h4>
                      <p>size:
                      <select name="s_size" id="sssize-{{$item->User_id}}">
                      <option value=""></option>
                        <option value="6">6</option>
                         <option value="7">7</option>
                          <option value="8">8</option>
                      ...
                      <h6>Qty:<input type="number" value="0" id="ssqty-{{$item->User_id}}" name="s_qty" style="width:30px;margin-button:20px;" min="0"></h6>
                    </div>
                ...
                <input type="hidden" name="s_color" value="{{$item->Color}}">
                <input type="hidden" name="s_price" value="{{$item->Price}}">
                <input type="hidden" name="s_size" id="sshidden-size-{{$item->User_id}}">
                <input type="hidden" name="s_qty" id="sshidden-qty-{{$item->User_id}}">
                <button type="submit" class="btn1 btn-sm btn-primary mx-auto" onclick="updateBuyNowForm_m1({{$item->User_id}})">Buy Now</button>
               </form>
                </div>
            </div>
        </div>
            ...
            <div class="card product-item border-0 mb-4">
                ...
                <div class="card-body border-left border-right text-center p-0 pt-4 pb-3" >
                    ...
                    <div class="d-flex justify-content-center" >
                      <h4>&#8377;<input type="number" value="{{$item->Price}}" name="s_price" readonly style="width:110px;margin-right:100px;" > </h4>
                      <p>size:
                      <select name="s_size" id="ssssize-{{$item->User_id}}">
                      <option value=""></option>
                        <option value="6">6</option>
                         <option value="7">7</option>
                          <option value="8">8</option>
                      ...
                      <h6>Qty:<input type="number" value="0" id="sssqty-{{$item->User_id}}" name="s_qty" style="width:30px;margin-button:20px;" min="0"></h6>
                    </div>
                ...
                <input type="hidden" name="s_color" value="{{$item->Color}}">
                <input type="hidden" name="s_price" value="{{$item->Price}}">
                <input type="hidden" name="s_size" id="ssshidden-size-{{$item->User_id}}">
                <input type="hidden" name="s_qty" id="ssshidden-qty-{{$item->User_id}}">
                <button type="submit" class="btn1 btn-sm btn-primary mx-auto" onclick="updateBuyNowForm_m2({{$item->User_id}})">Buy Now</button>
               </form>
                </div>
            </div>
        </div>
...
function updateBuyNowFormm(itemId) {
    // Get the selected size and quantity
    var size = document.getElementById('ssize-' + itemId).value;
    var qty = document.getElementById('sqty-' + itemId).value;
    
    // Set the values in the hidden input fields of the Buy Now form
    document.getElementById('shidden-size-' + itemId).value = size;
    document.getElementById('shidden-qty-' + itemId).value = qty;
    
    // Submit the form
    document.getElementById('buy-now-form-' + itemId).submit();
}
function updateBuyNowForm_m1(itemId) {
    // Get the selected size and quantity
    var size = document.getElementById('sssize-' + itemId).value;
    var qty = document.getElementById('ssqty-' + itemId).value;
    
    // Set the values in the hidden input fields of the Buy Now form
    document.getElementById('sshidden-size-' + itemId).value = size;
    document.getElementById('sshidden-qty-' + itemId).value = qty;
    
    // Submit the form
    document.getElementById('buy-now-form-' + itemId).submit();
}
function updateBuyNowForm_m2(itemId) {
    // Get the selected size and quantity
    var size = document.getElementById('ssssize-' + itemId).value;
    var qty = document.getElementById('sssqty-' + itemId).value;
    
    // Set the values in the hidden input fields of the Buy Now form
    document.getElementById('ssshidden-size-' + itemId).value = size;
    document.getElementById('ssshidden-qty-' + itemId).value = qty;
