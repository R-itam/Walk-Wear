...
<body>
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <!-- Navbar End -->
             <h1 align="center" style="color:red;">ALL JACKET </h1>
            <!-- Recent Sales Start -->
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                       ...
                       <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody align="center">
                                <tr>
                                    ...
                                    <td><a class="btn btn-sm btn-primary" href="{{url('/basketball_del')}}{{$item->User_id}}">Delete</a></td>
                                </tr>
                    ...
                    <a href="{{url('/basketballsection')}}"> < < < </a>
                </div>
            </div>
            <!-- Recent Sales End -->
