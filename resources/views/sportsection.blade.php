    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <h1 align="center" style="color:red;">SPORT  SECTION</h1><br><br>
                <div class="row g-4">
                    <div class="col-sm-12 col-md-6 col-xl-4">
                        <div class="h-100 bg-secondary rounded p-4">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <h3 style="color:red;"   >SPORT  ADD</h3>
                            </div>
                            <img src="banner/sports/MNIKEAIRZOOMTR1.png" alt="" height="200px"width="350px">
                           <hr>
                         <center>  <a href="{{url('/sportadd')}}"class="btn btn-md btn-primary">ADD >>></a></center>
                    ...
                    <div class="col-sm-12 col-md-6 col-xl-4">
                        <div class="h-100 bg-secondary rounded p-4">
                        <div class="d-flex align-items-center justify-content-between mb-2">
                                <h3 style="color:red;"   >SPORT  EDIT</h3>
                            </div>
                            <img src="banner/sports/NIKEJUNIPERTRAIL3.png" alt="" height="200px" width="350px">
                           <hr>
                         <center>  <a href="{{url('/sportsectioneditview')}}"class="btn btn-md btn-primary">EDIT & DELETE >>></a></center>
                        </div>
                    </div>
