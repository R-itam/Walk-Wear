...
<body>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px;background-image:url(banner/cover/cool-green.png);
            background-repeat:no-repeat;
            background-size:cover ;">
            <h1 class="font-weight-semi-bold text-uppercase mb-3" style="color:white;font-weight:40px;"><strong>WOMEN SECTION</strong></h1>
    ...
    <!-- Page Header End -->
            ...
            <div class="card product-item border-0 mb-4">
                ...
                <button type="submit" class="btn1 btn-sm btn-primary mx-auto" onclick="updateBuyNowForm_m({{$item1->User_id}})">Buy Now</button>
               </form>
                </div>
            </div>
        </div>
...
function updateBuyNowForm_m(itemId) {
    // Get the selected size and quantity
