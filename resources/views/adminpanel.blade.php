                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">
                            <a href="{{url('/myinfo')}}" class="dropdown-item">My Profile</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-1">
                            <img src="banner/limited/jordon1.webp" alt="" height="200px">
                            <div class="ms-3">
                                <p class="mb-2">Limited Edition</p>
                                <a href="{{url('/limitedsection')}}"><b>Go >>></b></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-7">
                           <img src="banner/snek/AIRJORDAN1ZMAIRCMFT2.png" alt="" height="200px">
                            <div class="ms-3">
                                <p class="mb-2">Sneakers</p>
                               <a href="{{url('/snekarsection')}}"><b>Go >>></b></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-7">
                         <img src="banner/sandel/JORDANUMPMANSLIDE.png" alt="" height="200px">
                            <div class="ms-3">
                                <p class="mb-2">Slippers</p>
                                <a href="{{url('/slippersection')}}"><b>Go >>></b></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-7">
                           <img src="banner/women/WMNSAIRJORDAN1MID.png" alt="" height="200px">
                            <div class="ms-3">
                                <p class="mb-2">Women</p>
                               <a href="{{url('/womensection')}}"><b>Go >>></b></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-7">
                           <img src="banner/sports/MNIKEAIRZOOMTR1.png" alt="" height="200px">
                            <div class="ms-3">
                                <p class="mb-2">Sports</p>
                                <a href="{{url('/sportsection')}}"><b>Go >>></b></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-7">
                           <img src="banner/tshirt/MAX90TEE.png" alt="" height="200px">
                            <div class="ms-3">
                                <p class="mb-2">T-Shirt</p>
                                <a href="{{url('/tshirtsection')}}"><b>Go >>></b></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-7">
                           <img src="banner/jacket/FULLZIP.png" alt="" height="200px">
                            <div class="ms-3">
                                <p class="mb-2">Jacket</p>
                                <a href="{{url('/jacketsection')}}"><b>Go >>></b></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-7">
                           <img src="banner/newarrive/HYDROXI.png" alt="" height="200px">
                            <div class="ms-3">
                                <p class="mb-2">New Arrival</p>
                                <a href="{{url('/newarrivalsection')}}"><b>Go >>></b></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-7">
                           <img src="banner/basket/3PF.png" alt="" height="200px">
                            <div class="ms-3">
                                <p class="mb-2">Basketball Section</p>
                                <a href="{{url('/basketballsection')}}"><b>Go >>></b></a>
                            </div>
                        </div>
                    </div>
                </div>
                       ...
                       <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody align="center">
                                <tr>
                                    ...
                                    <td><a class="btn btn-sm btn-primary" href="{{url('/block')}}{{$item->User_id}}">BLOCK</a> <a class="btn btn-sm btn-success" href="{{url('/unblock')}}{{$item->User_id}}">UNBLOCK</a></td>
                                    <td>@if ($item->Auth==0)
                                        <b>Unblock</b>
                                        @else
                                        <b>Block</b>
